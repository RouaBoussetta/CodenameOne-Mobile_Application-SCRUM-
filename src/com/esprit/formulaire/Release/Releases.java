 ...
 * @author Lenovo
 */
public class Releases extends SideMenuBaseForm {

    Form current;

    public Releases(User u, Resources res) {
        ...
        Container titleComponent
                ...
                add(BorderLayout.SOUTH,
                        FlowLayout.encloseIn(
                                new Label("  Releases  ", "WelcomeBlue"),
        ...
        if (u.getRoles().equals("[ROLE_MASTER, ROLE_USER]") || u.getRoles().equals("[ROLE_PRODUCT_OWNER, ROLE_USER]")) {
            ...
            add.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    new AddRelease(u, res).show();
                }
            });
            B.add(add);
            add(B);
        }
        for (Release i : ReleaseService.getInstance().getAllReleases()) {
            Container InfoContainer = new Container(BoxLayout.y());
            Label l = new Label(i.getName());
            ...
            Container.add(res.getImage("release.png").scaled(150, 150));
            ...
            l.addPointerPressedListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    ...
                    new ReleaseDetail(i, u, res).show();
